...
void main()
{
	...
	*/
	...
	//Range-based for - for  для диапазона. Под диапазоном понимается
	// контейнер или же какая то структура данных (какой то набор элементов)
